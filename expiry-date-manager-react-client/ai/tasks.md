...
- [] Implement backend product API endpoints (POST /products, GET /products, DELETE /products) and create Dashboard page where users are redirected after login to add and manage product expiry dates.