...
import { Clock, Eye, EyeOff, UserPlus, AlertCircle, CheckCircle2, ArrowLeft, User, Mail, Lock } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-primary/20 selection:text-primary">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Start tracking inventory and expiration dates today
        </p>
      </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pl-11 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary text-gray-900 placeholder-gray-400 text-sm transition-all outline-none"
                />
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-semibold text-gray-700 mb-1">
                Password <span className="text-xs font-normal text-gray-500">(Min. 6 characters)</span>
              </label>
              <div className="relative">
                <input
                  id="password"
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pl-11 pr-11 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary text-gray-900 placeholder-gray-400 text-sm transition-all outline-none"
                />
